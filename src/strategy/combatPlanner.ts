import { CombatPotentials, CombatIntel } from "intel/CombatIntel";
import { DefenseDirective } from "directives/defense/_defenceDirective";
	...
	private assembleSquads(): void {
		...
		for (const creep of this.creeps) {
			if (!creep.overlord) {
				...
				const creepDirective = (<CombatCommander>creep.overlord).directive;
	...
	static getThreat(directive: DefenseDirective): Threat {
		...
		if (directive.room) {
			return {
				...
				closestColony: directive.base.name,
