...
export function getPosFromBunkerCoord(coord: Coord, base: Base): RoomPosition {
	if (base.roomPlanner.memory.bunkerData && base.roomPlanner.memory.bunkerData.anchor) {
		let dx = base.roomPlanner.memory.bunkerData.anchor.x - bunkerLayout.data.anchor.x;
		let dy = base.roomPlanner.memory.bunkerData.anchor.y - bunkerLayout.data.anchor.y;
